...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: 'https://www.imba.live/esim', lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
    { url: 'https://www.imba.live/virtual-card', lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
