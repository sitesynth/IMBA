...
export default function RefundPage() {
  return (
    <article className="prose-legal">
      ...
      <h2>Основы</h2>
      <p>
        Клиент имеет право вернуть средства за неиспользованные услуги в полном объёме. Средства
        зачисляются только на аккаунт клиента в биллинг-системе компании и могут быть потрачены
        на любые другие услуги компании или переведены на счёт другого клиента.
      </p>
      ...
      <ul>
        ...
        <li>срок выполнения возврата может составлять от 1 до 45 дней;</li>
        <li>
          возврат производится на ваш баланс IMBA или на доступную платёжную систему,
          если это возможно;
        </li>
        <li>
          из суммы возврата за выделенные серверы вычитается стоимость 1 (одного) полного
          месяца обслуживания по текущему тарифу.
        </li>
      </ul>
