    ...
    >
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0">
          <p className="font-extrabold text-sm leading-tight">Добавить IMBA на экран</p>
          <p className="text-xs font-semibold opacity-50 leading-tight">Как приложение — без браузера</p>
        </div>
      </div>
      <div className="flex items-center gap-2 shrink-0">
        <button onClick={install}
          ...
          style={{ gap: 4 }}>
          <Plus className="w-3.5 h-3.5" strokeWidth={3} /> Добавить
        </button>
